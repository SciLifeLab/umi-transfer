...
run_in:
	@cargo run --release -- --no-gzip --r1-in /Users/judit/Downloads/barcodex-rs-master/inline-test/test_fil_R1.fastq --r2-in /Users/judit/Downloads/barcodex-rs-master/inline-test/test_fil_R2.fastq inline --pattern1 NNNNNNNNN --pattern2 NNNNNNNNN
run_gz:
...
run_sing:
	@cargo run --release -- --no-gzip --r1-in /Users/judit/Downloads/barcodex-rs-master/inline-test/test_fil_R1.fastq inline --pattern1 NNNNNNNNN
run_sing_gz:
	@cargo run --release -- --no-gzip --r1-in /Users/judit/Downloads/barcodex-rs-master/inline-test/test_fil_R1.fastq.gz inline --pattern1 NNNNNNNNNN
run_in_test:
	@cargo run --release -- --no-gzip --r1-in /Users/judit/Downloads/barcodex-rs-master/inline-test/test_fil_R1.fastq --r2-in /Users/judit/Downloads/barcodex-rs-master/inline-test/test_fil_R2.fastq inline --pattern1 NNNNNNNNN
clean:
	rm -f integrated*